...
use Gett\MyparcelNL\Service\Consignment\Create;
use Gett\MyparcelNL\Service\Consignment\Update;
use Symfony\Component\HttpFoundation\Request;
use Gett\MyparcelNL\Service\Consignment\Download;
use Gett\MyparcelNL\Repository\OrderLabelRepository;
...
//        $repository = $this->get('gett.myparcelnl.repository.order_label_repository');
//
//        /** @var Create $service */
//        $service = $this->get('gett.myparcelnl.service.consignment.create');
//
...
//        $service = $this->get('gett.myparcelnl.service.consignment.download');
//
...
//    {
//        /** @var Update $service */
//        $service = $this->get('gett.myparcelnl.service.consignment.update');
//
