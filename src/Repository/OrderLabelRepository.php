...
namespace Gett\MyparcelNL\Repository;
...
class OrderLabelRepository
{
    ...
    public function getIdLabelByBarcode(string $barcode)
    {
        ...
        $qb->from($this->tablePrefix . 'myparcelnl_order_label', 'ol');
    ...
    private function getOrderQueryBuilder(): QueryBuilder
    {
        ...
        $qb->innerJoin('o', $this->tablePrefix . 'myparcelnl_delivery_settings', 'ds', 'o.id_cart = ds.id_cart');
