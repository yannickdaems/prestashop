...
namespace Gett\MyparcelNL;

class Constant
{
    const POSTNL_DEFAULT_CARRIER = 'MYPARCELNL_DEFAULT_CARRIER';
    ...
    const API_KEY_CONFIGURATION_NAME = 'MYPARCELNL_API_KEY';
    const API_LOGGING_CONFIGURATION_NAME = 'MYPARCELNL_API_LOGGING';

    const PACKAGE_TYPE_CONFIGURATION_NAME = 'MYPARCELNL_PACKAGE_TYPE';
    const ONLY_RECIPIENT_CONFIGURATION_NAME = 'MYPARCELNL_RECIPIENT_ONLY';
    const AGE_CHECK_CONFIGURATION_NAME = 'MYPARCELNL_AGE_CHECK';
    const PACKAGE_FORMAT_CONFIGURATION_NAME = 'MYPARCELNL_PACKAGE_FORMAT';

    const RETURN_PACKAGE_CONFIGURATION_NAME = 'MYPARCELNL_RETURN_PACKAGE';
    const SIGNATURE_REQUIRED_CONFIGURATION_NAME = 'MYPARCELNL_SIGNATURE_REQUIRED';
    const INSURANCE_CONFIGURATION_NAME = 'MYPARCELNL_INSURANCE';
    const CUSTOMS_FORM_CONFIGURATION_NAME = 'MYPARCELNL_CUSTOMS_FORM';
    const CUSTOMS_CODE_CONFIGURATION_NAME = 'MYPARCELNL_CUSTOMS_CODE';
    const DEFAULT_CUSTOMS_CODE_CONFIGURATION_NAME = 'MYPARCELNL_DEFAULT_CUSTOMS_CODE';
    const CUSTOMS_ORIGIN_CONFIGURATION_NAME = 'MYPARCELNL_CUSTOMS_ORIGIN';
    const DEFAULT_CUSTOMS_ORIGIN_CONFIGURATION_NAME = 'MYPARCELNL_DEFAULT_CUSTOMS_ORIGIN';
    const CUSTOMS_AGE_CHECK_CONFIGURATION_NAME = 'MYPARCELNL_CUSTOMS_AGE_CHECK';
    ...
    const SHARE_CUSTOMER_EMAIL_CONFIGURATION_NAME = 'MYPARCELNL_SHARE_CUSTOMER_EMAIL';
    const SHARE_CUSTOMER_PHONE_CONFIGURATION_NAME = 'MYPARCELNL_SHARE_CUSTOMER_PHONE';
    const USE_ADDRESS2_AS_STREET_NUMBER_CONFIGURATION_NAME = 'MYPARCELNL_USE_ADDRESS2_AS_STREET_NUMBER';

    const LABEL_DESCRIPTION_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_DESCRIPTION';
    const LABEL_OPEN_DOWNLOAD_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_OPEN_DOWNLOAD';
    const LABEL_SIZE_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_SIZE';
    const LABEL_POSITION_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_POSITION';
    const LABEL_PROMPT_POSITION_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_PROMPT_POSITION';

    const LABEL_CREATED_ORDER_STATUS_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_CREATED_ORDER_STATUS';
...
//        'priceStandardDelivery',
    ...
    const STATUS_CHANGE_MAIL_CONFIGURATION_NAME = 'MYPARCELNL_STATUS_CHANGE_MAIL';
    const SENT_ORDER_STATE_FOR_DIGITAL_STAMPS_CONFIGURATION_NAME = 'MYPARCELNL_SENT_ORDER_STATE_FOR_DIGITAL_STAMPS';
    const LABEL_SCANNED_ORDER_STATUS_CONFIGURATION_NAME = 'MYPARCELNL_LABEL_SCANNED_ORDER_STATUS';
    const DELIVERED_ORDER_STATUS_CONFIGURATION_NAME = 'MYPARCELNL_DELIVERED_ORDER_STATUS';
    const ORDER_NOTIFICATION_AFTER_CONFIGURATION_NAME = 'MYPARCELNL_ORDER_NOTIFICATION_AFTER';

    const IGNORE_ORDER_STATUS_CONFIGURATION_NAME = 'MYPARCELNL_IGNORE_ORDER_STATUS';
    const WEBHOOK_ID_CONFIGURATION_NAME = 'MYPARCELNL_WEBHOOK_ID';

    const POSTNL_CONFIGURATION_NAME = 'MYPARCELNL_POSTNL';
    const BPOST_CONFIGURATION_NAME = 'MYPARCELNL_BPOST';
    const DPD_CONFIGURATION_NAME = 'MYPARCELNL_DPD';
