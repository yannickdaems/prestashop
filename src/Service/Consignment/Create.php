...
namespace Gett\MyparcelNL\Service\Consignment;
...
class Create
{
    ...
    public function __construct(EntityManagerInterface $entityManager, MyparcelStatusProvider $status_provider, \Gett\MyparcelNL\Factory\Consignment\ConsignmentFactory $factory)
    {
