...
class AdminOrderList extends AbstractAdminOrder
{
    ...
    public function getAdminAfterHeader(): string
    {
        ...
        $this->context->smarty->assign([
            'action' => $link->getAdminLink('AdminMyParcelNLLabel', true, [], ['action' => 'createLabel']),
    ...
    public function setHeaderContent(): void
    {
        ...
        Media::addJsDef(
            [
                ...
                'delivery_settings_route' => $link->getAdminLink('AdminMyParcelNLLabel', true, [], [
                    'action' => 'getDeliverySettings',
                    'id_order' => Tools::getValue('id_order'),
                ]),
                'create_labels_bulk_route' => $link->getAdminLink('AdminMyParcelNLLabel', true, [], ['action' => 'createb']),
                'refresh_labels_bulk_route' => $link->getAdminLink('AdminMyParcelNLLabel', true, [], ['action' => 'refresh']),
                'create_label_action' => $link->getAdminLink('AdminMyParcelNLLabel', true, [], ['action' => 'createLabel', 'listingPage' => true]),
