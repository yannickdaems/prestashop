...
namespace Gett\MyparcelNL\Module;
...
class Installer
{
    ...
    public function getAdminTabsDefinition()
    {
        ...
        foreach (\Language::getLanguages(true) as $lang) {
            ...
            $languages['MyParcelController'][$lang['id_lang']] = 'MyParcelNL';
        }

        return [
            'MyParcelLabelController' => [
                'class_name' => 'AdminMyParcelNLLabel',
    ...
    protected function addCarrier($configuration)
    {
        ...
        try {
            if ($carrier->add()) {
                ...
                Db::getInstance()->insert('myparcelnl_carrier_configuration', $insert);
