<div id="myparcel-order-panel" class="panel" data-url="{$labelUrl}">
  <div class="panel-heading">
    <img src="{$modulePathUri}views/images/myparcelnl-grayscale.png" alt="" /> {l s='MyParcel' mod='myparcelnl'}
  </div>
  <div class="row">
    <div class="col-lg-6">
      <div class="panel form-horizontal">
        <div class="panel-heading">
          <i class="icon-file-text"></i> {l s='Concept' mod='myparcelnl'}
        ...
        <div class="panel-footer-wrapper">
          <button type="submit" name="submitCreateConcept" class="btn btn-default" id="submitCreateConcept">
            <i class="icon-save"></i> {l s='Save' mod='myparcelnl'}
          </button>
          <div class="btn-group">
            <button class="btn btn-default" type="button" name="submitCreateLabel" id="submitCreateLabel">
              <i class="icon-plus"></i> {l s='New shipment' mod='myparcelnl'}
            </button>
            <button
            ...
            >
              <i class="icon-plus"></i> <i class="icon-print"></i> {l s='New shipment & print' mod='myparcelnl'}
            </button>
          </div>
        </div>
      </div>
    ...
    <div class="col-lg-6">
      <div class="panel">
        <div class="panel-heading">
          <i class="icon-truck"></i> {l s='Shipments' mod='myparcelnl'}
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalLongTitle">{l s='Print' mod='myparcelnl'}</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="button_print_label" class="btn btn-primary">{l s='Create and print' mod='myparcelnl'}</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="deliveryDateModal" tabindex="-1" role="dialog" aria-labelledby="deliveryDateModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="deliveryDateModalTitle">{l s='Delivery Options' mod='myparcelnl'}</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="labelReturnModal" tabindex="-1" role="dialog" aria-labelledby="labelReturnModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="labelReturnModalTitle">{l s='Email return label to your customer' mod='myparcelnl'}</h2>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
