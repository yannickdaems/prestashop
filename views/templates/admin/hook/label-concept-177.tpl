...
<div class="form-group row">
  <label class="col-sm-4 col-form-label" for="packageTypeSelect">{l s='Package type' mod='myparcelnl'}</label>
  <div class="col-sm-8">
    <select name="packageType" class="form-control custom-select" id="packageTypeSelect">
      {if !empty($carrierSettings.delivery.packageType[1])}
        <option value="1"{if !empty($labelOptions.package_type) && $labelOptions.package_type eq 1} selected{/if}>{l s='Parcel' mod='myparcelnl'}</option>
      {/if}
      {if !empty($carrierSettings.delivery.packageType[2])}
        <option value="2"{if !empty($labelOptions.package_type) && $labelOptions.package_type eq 2} selected{/if}>{l s='Mailbox package' mod='myparcelnl'}</option>
      {/if}
      {if !empty($carrierSettings.delivery.packageType[3])}
        <option value="3"{if !empty($labelOptions.package_type) && $labelOptions.package_type eq 3} selected{/if}>{l s='Letter' mod='myparcelnl'}</option>
      {/if}
      {if !empty($carrierSettings.delivery.packageType[4])}
        <option value="4"{if !empty($labelOptions.package_type) && $labelOptions.package_type eq 4} selected{/if}>{l s='Digital stamp' mod='myparcelnl'}</option>
      {/if}
    </select>
  </div>
</div>
<div class="form-group row">
  <label class="col-sm-4 col-form-label" for="packageFormatSelect">{l s='Package format' mod='myparcelnl'}</label>
  <div class="col-sm-8">
    <select name="packageFormat" class="form-control custom-select" id="packageFormatSelect">
      {if !empty($carrierSettings.delivery.packageFormat[1])}
        <option value="1"{if !empty($labelOptions.package_format) && $labelOptions.package_format eq 1} selected{/if}>{l s='Normal' mod='myparcelnl'}</option>
      {/if}
      {if !empty($carrierSettings.delivery.packageFormat[2])}
        <option value="2"{if !empty($labelOptions.package_format) && $labelOptions.package_format eq 2} selected{/if}>{l s='Large' mod='myparcelnl'}</option>
      {/if}
      {if !empty($carrierSettings.delivery.packageFormat[3])}
        <option value="3"{if !empty($labelOptions.package_format) && $labelOptions.package_format eq 3} selected{/if}>{l s='Automatic' mod='myparcelnl'}</option>
      {/if}
    </select>
  </div>
</div>
<div class="form-group row">
  <label class="col-sm-4 col-form-label" for="label_amount">{l s='Number of labels' mod='myparcelnl'}</label>
  <div class="col-lg-2">
...
{if $date_warning_display}
  <div class="alert alert-warning">
      {l s='The delivery timeframe has been moved to a new date.' mod='myparcelnl'}
  </div>
{/if}
