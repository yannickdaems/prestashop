    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{l s='Print' mod='myparcelnl'}</h5>
                    ...
                    <div class="myparcel-radio-wrapper">
                        <div class="myparcel-radio-container">
                            <input
                                    ...
                                    {if $labelConfiguration.MYPARCELNL_LABEL_SIZE eq 'a4'}checked="checked"{/if}
                            >
                            <label for="a4">{l s='A4' mod='myparcelnl'}</label>
                        </div>
                        <div class="myparcel-radio-container">
                            <input
                                    id="a6"
                                    ...
                                    {if $labelConfiguration.MYPARCELNL_LABEL_SIZE eq 'a6'}checked="checked"{/if}
                            >
                            <label for="a6">{l s='A6' mod='myparcelnl'}</label>
                        </div>
                    </div>
                    <br>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' mod='myparcelnl'}</button>
                <button type="button" id="print_button" class="btn btn-primary">{l s='Save changes' mod='myparcelnl'}</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="bulk-print" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                    ...
                    <div class="myparcel-radio-wrapper">
                        <div class="myparcel-radio-container">
                            <input
                                    ...
                                    {if $labelConfiguration.MYPARCELNL_LABEL_SIZE eq 'a4'}checked="checked"{/if}
                            >
                            <label for="a4_bulk">{l s='A4' mod='myparcelnl'}</label>
                        </div>
                        <div class="myparcel-radio-container">
                            <input
                                    id="a6_bulk"
                                    ...
                                    {if $labelConfiguration.MYPARCELNL_LABEL_SIZE eq 'a6'}checked="checked"{/if}
                            >
                            <label for="a6_bulk">{l s='A6' mod='myparcelnl'}</label>
                        </div>
                    </div>
                    <br>
                    <div class="positions-block">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' mod='myparcelnl'}</button>
                <button type="submit" id="print-bulk-button" class="btn btn-primary">{l s='Save changes' mod='myparcelnl'}</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{l s='Create' mod='myparcelnl'}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" id="print-modal">
                ...
                <div class="form-group">
                    <label for="labels_amount">{l s='Amount of labels' mod='myparcelnl'}</label>
                    <input id="labels_amount" name="label_amount" value="1" type="number" min="1" class="form-control">
                </div>

                <div class="form-group">
                    <label for="packageType">{l s='Package type' mod='myparcelnl'}</label>
                ...
                <div class="form-group">
                    <label for="packageFormat">{l s='Package format' mod='myparcelnl'}</label>
                ...
                <div class="form-group">
                    ...
                    <label for="onlyRecipient">{l s='Only to receipient' mod='myparcelnl'}</label>
                </div>

                {if !$isBE}
                <div class="form-group">
                    <input type="checkbox" value="1" id="ageCheck" name="ageCheck">
                    <label for="ageCheck">{l s='Age check' mod='myparcelnl'}</label>
                </div>
                {/if}
                ...
                <div class="form-group">
                    ...
                    <label for="returnUndelivered">{l s='Return package' mod='myparcelnl'}</label>
                </div>
                {/if}

                <div class="form-group">
                    <input type="checkbox" value="1" id="signatureRequired" name="signatureRequired">
                    <label for="signatureRequired">{l s='Signature' mod='myparcelnl'}</label>
                </div>
                    ...
                    {if !$isBE}
                        <div class="form-group insurance-amount-custom">
                            <div class="myparcel-radio-container">
                                ...
                                <label for="heigherthen500">{l s='Higher than € 500' mod='myparcelnl'}</label>
                            </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{l s='Close' mod='myparcelnl'}</button>
                <button type="button" id="add" class="btn btn-primary">{l s='Save changes' mod='myparcelnl'}</button>
            </div>
        </div>
    </div>
</div>
...
>
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bulkExportPrintModalLongTitle">{l s='Export and Print' mod='myparcelnl'}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                    ...
                    <div class="myparcel-radio-wrapper">
                        <div class="myparcel-radio-container">
                            <input
                                    ...
                                    {if $labelConfiguration.MYPARCELNL_LABEL_SIZE eq 'a4'}checked="checked"{/if}
                            >
                            <label for="a4_bulk_export_print">{l s='A4' mod='myparcelnl'}</label>
                        </div>
                        <div class="myparcel-radio-container">
                            <input
                                    type="radio"
                                    ...
                                    {if $labelConfiguration.MYPARCELNL_LABEL_SIZE eq 'a6'}checked="checked"{/if}
                            >
                            <label for="a6_bulk_export_print">{l s='A6' mod='myparcelnl'}</label>
                        </div>
                    </div>
                    <br>
                    <div class="positions-block">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="export-print-bulk-button" class="btn btn-primary">
                    {l s='Export and print' mod='myparcelnl'}
                </button>
            </div>
        </div>
    </div>
