...
use Gett\MyparcelNL\Factory\Consignment\ConsignmentFactory;
...
use Gett\MyparcelNL\Module\Tools\Tools;
...
class AdminMyParcelNLLabelController extends ModuleAdminController
{
    ...
    public function ajaxProcessCreateLabel()
    {
        ...
        try {
            ...
            $this->errors[] = sprintf($this->module->l(
                'MyParcelNL: Delivery address is not valid for order ID: %d.',
                'adminlabelcontroller'
            ), (int) $idOrder);
            $this->returnAjaxResponse();
        } catch (Exception $e) {
